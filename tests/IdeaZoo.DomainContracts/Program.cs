...
internal static class Program
{
    ...
    private static void TestStrictAnalysis()
    {
        ...
        var translation = IdeaAnalyzer.Analyze(new IdeaIntake
        {
    ...
    private static void TestCompleteCase()
    {
        ...
        var profile = director.Begin(new IdeaIntake
        {
            Title = "Meeting Bridge",
            Idea = "A headset using AI models to translate business meetings in real time.",
            Problem = "People lose trust and detail across languages.",
        ...
        director.EnterMolt();
        Check(director.Stage == CaseStage.Molt, "case did not enter Molt");
        director.CancelMolt();
    ...
    private static void TestInvalidTransitions()
    {
        ...
        director.EnterZoo();
        Expect<InvalidOperationException>(() => director.EnterMolt(), "Molt opened before all four habitats completed");
