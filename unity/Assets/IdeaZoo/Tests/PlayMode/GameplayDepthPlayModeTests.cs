...
namespace IdeaZoo.Tests.PlayMode
{
    public sealed class GameplayDepthPlayModeTests
    {
        ...
        {
            var roots = Resources.FindObjectsOfTypeAll<Component>()
                .Where(component => component != null
                    && component.GetType().FullName != null
                    && component.GetType().FullName.StartsWith("IdeaZoo.", StringComparison.Ordinal))
                .Select(component => component.transform.root.gameObject)
